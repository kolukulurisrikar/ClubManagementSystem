				    ...
				    <div class="container" style="min-width:90%">
				    	<div class="nav-header">
      					  ...
      					  <li>
      						<a href="#" class="fh5co-sub-ddown sf-with-ul">UPDATES</a>
      							<ul class="fh5co-sub-menu">
      								<li><a href="indexad1d.html?r=abou">NEWS</a></li>
      					...
      					<li><a href="#" class="fh5co-sub-ddown sf-with-ul">EVENTS</a>
      						<ul class="fh5co-sub-menu">
      							<li><a href="events_calendar.html">CALENDAR</a></li>
      							<li><a href="events_fests">FESTS</a></li>
      							<li><a href="events_workshops.html">WORKSHOPS</a></li>
      				   	</ul>
      					</li>
                            ...
                            <ul class="fh5co-sub-menu">
                              ...
                              <li><a href="index360b.html?r=events/workshop">ATHLETICS</a></li>
      						 ...
      						 <li ><a href="#" class="fh5co-sub-ddown sf-with-ul">PEOPLE</a>
      						   <ul class="fh5co-sub-menu">
      						    <li><a href="people_halloffame.html">HALL OF FAME</a></li>
      						    
      						   <li><a href="people_students.html">STUDENT COUNCIL</a></li>
      						   <li><a href="people_staff.html">STAFF</a></li>
      						 ...
      						 <li ><a href="#" class="fh5co-sub-ddown sf-with-ul">ADD ONS</a>
      						   <ul class="fh5co-sub-menu">
                                <li><a href="register_student.php">ADD STUDENT</a></li>
      						    <li><a href="register_fest.php">ADD FEST</a></li>
      						   <li><a href="register_event.php">ADD EVENT</a></li>

      					  	</ul>
      					    </li>
                                
                                <li ><a href="#" class="fh5co-sub-ddown sf-with-ul">GO ON</a>
      						   <ul class="fh5co-sub-menu">
                                <li><a href="view_events.php">STOCK DISPLAY</a></li>
      						    <li><a href="register.php">EVENTS CONDUCTED</a></li>
      						   <li><a href="register_customer.php">FESTS</a></li>

      					  	</ul>
      					    </li>
                             
                               echo '<li><a href="log_out.php" class="fh5co-sub-ddown sf-with-ul">Logout</a>';
...
<div class="fh5co-hero" style="height:100vh">
  <div class="fh5co-overlay" style = "height:100vh;background:url(images/titlepage.jpg) no-repeat center center fixed; background-size:cover"></div>
...
<ul class="collapsible popout" data-collapsible="accordion">
    <li>
      <div class="collapsible-header"><i class="material-icons">filter_drama</i>VIEW STUDENTS</div>
      <div class="collapsible-body"><span>DISPLAYS THE STUDENTS OF THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_student_basketball.php">CLICK HERE</a></span></div>
        
      
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">place</i>VIEW STOCK</div>
      <div class="collapsible-body"><span>DISPLAYS THE STOCK AVAILABLE FOR THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_stock_basketball.php">CLICK HERE</a></span></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">whatshot</i>VIEW EVENTS</div>
      <div class="collapsible-body"><span>DISPLAYS THE EVENTS ORGANIZED BY THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_events_basketball.php">CLICK HERE</a></span></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">explore</i>VIEW FESTS</div>
      <div class="collapsible-body"><span>DISPLAYS THE FESTS CONDUCTED BY THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_fests_basketball.php">CLICK HERE</a></span></div>
    </li>
  </ul>
      ...
      <div id="footer" style="padding-top:10px;padding-bottom:2px;">
        <div class="container">
          ...
          <script src="js/jquery.min.js"></script>
        	...
        	<!-- Stellar -->
        	<script src="js/jquery.stellar.min.js"></scrfspeedsipt>
        	<!-- Superfish -->
