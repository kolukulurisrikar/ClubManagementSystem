...
<ul class="collapsible popout" data-collapsible="accordion">
    <li>
      ...
      <div class="collapsible-body"><span>DISPLAYS THE STUDENTS OF THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_student_athletics.php">CLICK HERE</a></span></div>
        
      
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">place</i>VIEW STOCK</div>
      <div class="collapsible-body"><span>DISPLAYS THE STOCK AVAILABLE FOR THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_stock_athletics.php">CLICK HERE</a></span></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">whatshot</i>VIEW EVENTS</div>
      <div class="collapsible-body"><span>DISPLAYS THE EVENTS ORGANIZED BY THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_events_athletics.php">CLICK HERE</a></span></div>
    </li>
    <li>
      <div class="collapsible-header"><i class="material-icons">explore</i>VIEW FESTS</div>
      <div class="collapsible-body"><span>DISPLAYS THE FESTS CONDUCTED BY THE PARTICULAR CLUB..<a class="grey-text text-lighten-3" href="view_fests_athletics.php">CLICK HERE</a></span></div>
    </li>
  </ul>
