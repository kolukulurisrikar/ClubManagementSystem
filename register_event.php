			   ...
			   <header id="fh5co-header-section">
				    <div class="container" style="min-width:90%">
				    	<div class="nav-header">
			     			<nav id="fh5co-menu-wrap" style="background: url('images/adventure.png') repeat;" role="navigation">
...
<div id="fh5co-blog-section" class="fh5co-section-gray">
	...
	<div class="container">
      ...
      <div class="row"style="width:100%; margin-left:28%">
        <div class="input-field col s6">
          <i class="material-icons prefix">track_changes</i>
          <input name="eventname" id="icon_prefix" type="text" class="validate">
         ...
         <div class="input-field col s6"style="width:50%; margin-left:28%">
          ...
          <input  name="coordinator" id="icon_telephone" type="tel" class="validate">
          <label for="icon_telephone">Event Co-ordinator</label>
               <br><br>
        </div>
              <div class="input-field col s6"style="width:50%; margin-left:28%">
          <i class="material-icons prefix">perm_contact_calendar</i>
          <input name="month"id="icon_telephone" type="text" class="validate">
          <label for="icon_telephone">Event Month</label>
               <br><br>
        </div>
                <div class="input-field col s6"style="width:50%; margin-left:28%">
          <i class="material-icons prefix">play_for_work</i>
          <input name="participants"id="icon_telephone" type="tel" class="validate">
          <label for="icon_telephone">Participants</label>
               <br><br>
        </div>
  ...
  <div class="input-field col s12 m6"style="width:80%; margin-left:16%">
    <select class="icons" name="venue">
      <option value="" disabled selected>Choose your option</option>
      <option name="venue" data-icon="images/sample-1.jpg" class="circle">OAT</option>
      <option name="venue" data-icon="images/office.jpg" class="circle">L-107</option>
      <option name="venue" data-icon="images/yuna.jpg" class="circle">CC2</option>
         <option name="venue" data-icon="images/yuna.jpg" class="circle">Ground</option>
                 <option name="venue" data-icon="images/yuna.jpg" class="circle">court</option>
                 <option name="venue" data-icon="images/yuna.jpg" class="circle">commonroom</option>
    </select>
    <label>VENUE</label>
      <br><br>
  </div>
    ...
    <center>
      ...
      <div class="container">
        <div class="z-depth-1 grey lighten-4 row" style="display: inline-block; padding: 32px 48px 0px 48px; border: 1px solid #EEE;">
          ...
          <form class="col s12" method="post" action=register_check.php>
            <div class='row'>
              <div class='col s12'>
              </div>
            </div>
            ...
            <div class='row'>
              <div class='input-field col s12'>
                <input class='validate' type='tel' name='login' id='login' />
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/materialize/0.97.5/js/materialize.min.js"></script>
    ...
    <div class="modal-footer">
      <a href="#!" class="modal-action modal-close waves-effect waves-green btn-flat ">Agree</a>
						...
						<!--<button class="waves-effect waves-yellow btn" style="background-color:#FCC72C;" ><input type="submit" name="submit" value="CONDUCT">  </button>-->
